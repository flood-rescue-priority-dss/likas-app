          ...
          {step === 'form' && (
            <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-sm font-inter text-gray-400 uppercase tracking-widest">Change Email</h3>
              ...
              <form onSubmit={handleVerifyEmail} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-inter bg-[#F8F9FC] focus:outline-none focus:ring-2 focus:ring-[#1B75BC]/30 focus:border-[#1B75BC] focus:bg-white transition-all"
                  />
                </div>
                <div>
                  <label className="block text-xs font-inter font-medium text-gray-600 mb-1.5">New Email</label>
                  <input
                    type="email"
                    value={newEmail}
