        ...
        <div className="bg-white rounded-3xl shadow-xl w-full max-w-xl p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-5 items-center gap-8">
              ...
              <span className="col-span-3 px-4 py-2.5 text-sm font-inter text-gray-400 bg-gray-50 rounded-xl border border-transparent">
          ...
          <div className="border-t border-gray-100 pt-5 flex justify-between mt-5">
            <button
              type="button"
              onClick={onClose}
